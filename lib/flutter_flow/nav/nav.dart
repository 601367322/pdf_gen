...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/coinCap',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'CoinCap')
              : const CoinCapWidget(),
        ),
        FFRoute(
          name: 'CardDetail',
          path: '/cardDetail',
          builder: (context, params) => CardDetail(
            item: MockData.fromJson(jsonDecode(params.getParam(
              'item',
              ParamType.String,
              isList: false,
            ))),
        ...
        FFRoute(
          ...
          builder: (context, params) => AccountStatementWidget(
        ...
        FFRoute(
          name: 'MY_CardCopy',
          path: '/mYCardCopy',
          builder: (context, params) => const MYCardCopyWidget(),
        ),
        FFRoute(
          name: 'BTCreceipt',
          path: '/bTCreceipt',
          builder: (context, params) => const BTCreceiptWidget(),
        ),
        FFRoute(
          name: 'ETHreceipt',
          path: '/eTHreceipt',
          builder: (context, params) => const ETHreceiptWidget(),
        ),
        FFRoute(
          name: 'FGOLDreceipt',
          path: '/fGOLDreceipt',
          builder: (context, params) => const FGOLDreceiptWidget(),
        ),
        FFRoute(
          name: 'USDTreceipt',
          path: '/uSDTreceipt',
          builder: (context, params) => const USDTreceiptWidget(),
        )
